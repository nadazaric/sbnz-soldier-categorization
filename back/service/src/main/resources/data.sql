...
INSERT INTO MY_USER(id, name, username, password) values (1, 'Nada Zaric', 'admin', '$2a$12$SNAppbTdXwnOkjSjlpxNoOqCd6RQw4O7IabGuWH82a4wh9judY2SO');
INSERT INTO MY_USER_ROLES(user_id, roles_id) values (1, 1);

INSERT INTO MY_USER(id, name, username, password) values (2, 'Ranka Milovanovic', 'ranka', '$2a$12$SNAppbTdXwnOkjSjlpxNoOqCd6RQw4O7IabGuWH82a4wh9judY2SO');
